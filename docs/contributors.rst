...
Contributors to pyStrich since the 2015 fork:
...
* Axel Schlueter (`@schluete <https://github.com/schluete>`_)
* Björn Andersson
...
* Sebastian Hoogen
* Tobias Paepke (`@paepke <https://github.com/paepke>`_)
* Vladimir Mihailenco (`@vmihailenco <https://github.com/vmihailenco>`_)
* chris
* wiz
