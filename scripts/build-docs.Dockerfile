...
RUN uv run --frozen --no-sync sphinx-build -W --keep-going -b doctest docs docs/_build/doctest
RUN uv run --frozen --no-sync sphinx-build -W --keep-going -b text docs docs/_build/text
RUN uv run --frozen --no-sync sphinx-build -W --keep-going -b html docs docs/_build/html
